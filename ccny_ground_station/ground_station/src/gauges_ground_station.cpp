...
void *startROS (void *user)
{
  if (user != NULL)
  {
    ...
    sprintf(data->gauge1_name_f,"<big>%s</big>\n<span foreground=\"orange\"><i>(%s)</i></span>",gauge1_name.c_str (),gauge1_unit.c_str ());
    ...
    // -----------------------------------------------------------------      
    // **** topics subscribing
    ros::Subscriber sub = n.subscribe ("fake_alti", 1, updateAltitudeCallback);
...
int main (int argc, char **argv)
{
  ...
  g_object_set (GTK_GAUGE (data->gauge1),
                ...
                "red-strip-start", data->gauge1_red_strip_start,                                                                                                                                                                                                                    
                NULL);
  ...
  g_object_set (GTK_GAUGE (data->gauge2), 
                ...
                "sub-step", (gdouble) data->gauge2_sub_step, 
                "drawing-step", data->gauge2_drawing_step,                                                                                                                                                                                                                                                                                                     
                NULL);
  ...
  g_object_set (GTK_BAR_GAUGE (data->bg),
                ...
                "start-value-bar-3", data->start_value_bar_3, 
                "end-value-bar-3", data->end_value_bar_3,                                                                                                                                                                                                                                         
                NULL);
  ...
  g_object_set (GTK_VARIOMETER (data->vario), 
                ...
                "unit-step-value", data->variometer_step_value, 
                "radial-color", data->radial_color, NULL);
