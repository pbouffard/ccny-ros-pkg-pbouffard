...
void GTKGui::setUpGTK()
{
  ...
  if( ! gtk_builder_add_from_file(builder, filePath.c_str(), &error ) )
  {
  ...
  controls_.btnDrawCloud    = GTK_TOGGLE_BUTTON(gtk_builder_get_object(builder, "btnDrawCloud"));
  ...
  gtk_widget_set_gl_capability (controls_.drawArea, glconfig, NULL, TRUE, GDK_GL_RGBA_TYPE);
